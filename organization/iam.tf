...
# allowing myself access to the org
...
# these bindings allow spacelift-project-creator service account to administer service accounts on the project
...
# these bindings allow spacelift-project-creator service account to add billing details to new projects
...
# these bindings allow spacelift-project-creator service account to enable apis on the newly created project
